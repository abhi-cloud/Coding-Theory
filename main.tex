...
\section*{Updated PoA}
I have mostly covered what I had planned till this report (adding worked out problems is left), so I'll continue with the original plan i.e. trying to complete the text, \emph{A first Course in Coding Theory}\cite{mostly}, with some help from \emph{Introoduction to Coding Theory	}\cite{rarely}.
